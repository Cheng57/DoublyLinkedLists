...
namespace TestLibrary
{
    ...
    public class LinkedListTest
    {
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = new DoublyLinkedLists.LinkedList<Employee>();
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(1, out _); // Size == 1, Head and Tail also exist here.
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(10, out _); // Size == 1, Head and Tail also exist here.
            Assert.That(list.IsEmpty(), Is.False);
        }
        ...
        public void AddFirst_on_emptylist_Head_Updated_Test()
        {
            ...
            Assert.That(list.Head, Is.EqualTo(null));
            list.AddFirst(new Employee(1));
            Assert.That(list.Head.Element.CompareTo(new Employee(1)) == 0);
        }
        ...
        public void AddFirst_on_emptylist_Tail_Updated_Test()
        {
            ...
            Assert.That(list.Tail, Is.EqualTo(null));
            list.AddFirst(new Employee(1));
            Assert.That(list.Tail.Element.CompareTo(new Employee(1)) == 0);
        }
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = new DoublyLinkedLists.LinkedList<Employee>();
            Assert.That(() => list.AddFirst(null), Throws.Exception.TypeOf<ArgumentNullException>());
        }
        ...
        public void AddFirst_on_list_of_2_Head_tail_and_size_Updated_Test()
        {
            ...
            Assert.That(list.Head.Element.CompareTo(new Employee(2)) == 0);
            Assert.That(list.Tail.Element.CompareTo(new Employee(2)) == 0);
            Assert.That(list.Size, Is.EqualTo(1));
            list.AddFirst(new Employee(1));
            Assert.That(list.Head.Element.CompareTo(new Employee(1)) == 0);
            Assert.That(list.Tail.Element.CompareTo(new Employee(2)) == 0);
            Assert.That(list.Size, Is.EqualTo(2));
            Assert.True(CheckIntegrityBetweenAllNodes(list));
        }
        ...
        public void AddFirst_on_list_of_3_Head_tail_and_size_Updated_Test()
        {
            ...
            list.AddFirst(new Employee(1));
            Assert.That(list.Head.Element.CompareTo(new Employee(1)) == 0);
            Assert.That(list.Tail.Element.CompareTo(new Employee(3)) == 0);
        ...
        public void AddFirst_on_large_list_Head_tail_and_size_Updated_Test()
        {
            ...
            for (int i = listSize; i >= 1; i--)
            {
                ...
                Assert.That(list.Size, Is.EqualTo(Math.Abs(listSize - i) + 1));
                Assert.That(list.Head.Element.CompareTo(new Employee(i)) == 0);
                Assert.That(list.Tail.Element.CompareTo(new Employee(listSize)) == 0);
                Assert.True(CheckIntegrityBetweenAllNodes(list));
            }
            Assert.That(list.Head.Element.CompareTo(new Employee(1)) == 0);
            Assert.That(list.Tail.Element.CompareTo(new Employee(listSize)) == 0);
            Assert.That(list.Size, Is.EqualTo(listSize));
            Assert.True(CheckIntegrityBetweenAllNodes(list));
        }
        ...
        public void AddFirst_on_larger_Existing_list_Head_and_size_Updated_Test()
        {
            int listSize = 5;
            Node<Employee>[] nodes;
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(listSize, out nodes); // pregenerated list
            list.AddFirst(new Employee(listSize + 1)); // executes your AddFirst
            Assert.That(list.Size, Is.EqualTo(6)); // size increases
            Assert.That(list.Head.Element.CompareTo(new Employee(listSize + 1)) == 0); // head contains the new value
            Assert.That(list.Tail.Element.CompareTo(nodes[listSize - 1].Element) == 0); // tail is still the same
            Assert.True(CheckIntegrityBetweenAllNodes(list)); // all pointers are connected properly
        }
        #endregion
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(1, out _);
            Assert.That(list.Tail.Element.CompareTo(list.GetFirst()) == 0);
        }
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(10, out _);
            Assert.That(list.Head.Element.CompareTo(list.GetFirst()) == 0);
        }
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(1, out _);
            Assert.That(list.Tail.Element.CompareTo(list.GetLast()) == 0);
        }
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(5, out _);
            list.Clear();
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = new DoublyLinkedLists.LinkedList<Employee>();
            Assert.That(() => list.SetFirst(new Employee(1)), Throws.Exception.TypeOf<ApplicationException>());
        }
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(1, out _);
            Assert.That(() => list.SetFirst(null), Throws.Exception.TypeOf<ArgumentNullException>());
        }
        ...
        public void SetFirst_on_list_of_1_replaces_head_element_Test()
        {
            ...
            Assert.That(list.GetFirst().CompareTo(new Employee(2)) == 0);
        ...
        public void SetFirst_Returns_ReplacedElement_Test()
        {
            ...
            Assert.That(returnedData.CompareTo(new Employee(1)) == 0);
        }
        ...
        public void SetFirst_does_not_impact_an_existing_larger_list_Test()
        {
            ...
            Assert.That(returnedData.CompareTo(new Employee(1)) == 0);
            Assert.That(list.GetFirst().CompareTo(new Employee(6)) == 0);
            Assert.That(list.Size == 5);
            Assert.True(CheckIntegrityBetweenAllNodes(list));
        }
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = new DoublyLinkedLists.LinkedList<Employee>();
            Assert.That(() => list.SetLast(new Employee(1)), Throws.Exception.TypeOf<ApplicationException>());
        }
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(1, out _);
            Assert.That(() => list.SetLast(null), Throws.Exception.TypeOf<ArgumentNullException>());
        }
        ...
        public void SetLast_on_list_of_1_replaces_head_element_Test()
        {
            ...
            Assert.That(list.GetLast().CompareTo(new Employee(2)) == 0);
            Assert.That(list.Size, Is.EqualTo(1)); //ensure size doesn't change!
        }
        ...
        public void SetLast_does_not_impact_an_existing_larger_list_Test()
        {
            ...
            Assert.That(returnedData.CompareTo(new Employee(5)) == 0);
            Assert.That(list.GetLast().CompareTo(new Employee(6)) == 0);
            Assert.That(list.Size == 5);
            Assert.True(CheckIntegrityBetweenAllNodes(list));
        }
        #endregion
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = new DoublyLinkedLists.LinkedList<Employee>();
            Assert.That(() => list.AddLast(null), Throws.Exception.TypeOf<ArgumentNullException>());
        }
        ...
        public void AddLast_on_list_of_3_Head_tail_and_size_Updated_Test()
        {
            ...
            list.AddLast(new Employee(2));
            list.AddLast(new Employee(1));
            Assert.That(list.Head.Element.CompareTo(new Employee(3)) == 0);
            Assert.That(list.Tail.Element.CompareTo(new Employee(1)) == 0);
            Assert.That(list.Size, Is.EqualTo(3));
            Assert.True(CheckIntegrityBetweenAllNodes(list));
        }
        ...
        public void AddLast_on_large_list_Head_tail_and_size_Updated_Test()
        {
            ...
            for (int i = listSize; i >= 1; i--)
            {
                ...
                Assert.That(list.Head.Element.CompareTo(new Employee(listSize)) == 0);
                Assert.That(list.Tail.Element.CompareTo(new Employee(i)) == 0);
                Assert.That(list.Size, Is.EqualTo(Math.Abs(listSize - i + 1)));
            }
        ...
        public void AddLast_on_larger_Existing_list_Head_and_size_Updated_Test()
        {
            ...
            Assert.That(list.Size, Is.EqualTo(6)); // size increases
            Assert.That(list.Head.Element.CompareTo(nodes[0].Element) == 0); // head contains the new value
            Assert.That(list.Tail.Element.CompareTo(new Employee(listSize + 1)) == 0); // tail is still the same
            Assert.True(CheckIntegrityBetweenAllNodes(list)); // all pointers are connected properly
        }
        #endregion
        ...
        public void RemoveFirst_Returns_first_Element_Test()
        {
            ...
            Assert.That(returnedElement.CompareTo(firstElement) == 0);
        }
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(2, out _);
            var returnedElement = list.RemoveFirst();
            Assert.That(list.Size, Is.EqualTo(1));
            Assert.That(returnedElement.CompareTo(new Employee(1)) == 0);
            Assert.That(list.Head.Element.CompareTo(new Employee(2)) == 0);
            Assert.That(list.Tail.Element.CompareTo(new Employee(2)) == 0);
            Assert.True(CheckIntegrityBetweenAllNodes(list));
        }
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(3, out _);
            var returnedElement = list.RemoveFirst();
            Assert.That(list.Size, Is.EqualTo(2));
            Assert.That(returnedElement.CompareTo(new Employee(1)) == 0);
            Assert.That(list.Head.Element.CompareTo(new Employee(2)) == 0);
        ...
        {
            int listSize = 10;
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(listSize, out _);
            var returnedElement = list.RemoveFirst();
            Assert.That(list.Size, Is.EqualTo(listSize - 1));
            Assert.That(returnedElement.CompareTo(new Employee(1)) == 0);
            Assert.That(list.Head.Element.CompareTo(new Employee(2)) == 0);
            Assert.That(list.Tail.Element.CompareTo(new Employee(listSize)) == 0);
            Assert.True(CheckIntegrityBetweenAllNodes(list));
        ...
        public void RemoveFirst_multiple_times_on_larger_list_updates_head_pointers_size_Test()
        {
            ...
            {
                var returnedElement = list.RemoveFirst();
                Assert.That(returnedElement.CompareTo(new Employee(i)) == 0);
                Assert.That(list.Size, Is.EqualTo(listSize - i));
                Assert.That(list.Head.Element.CompareTo(new Employee(i + 1)) == 0);
                Assert.That(list.Tail.Element.CompareTo(new Employee(listSize)) == 0);
                Assert.True(CheckIntegrityBetweenAllNodes(list));
            }
            var lastReturnedElement = list.RemoveFirst();
            Assert.That(lastReturnedElement.CompareTo(new Employee(listSize)) == 0);
        ...
        public void RemoveLast_on_list_2_updates_head_pointers_size_Test()
        {
            ...
            var returnedElement = list.RemoveLast();
            Assert.That(list.Size, Is.EqualTo(1));
            Assert.That(returnedElement.CompareTo(new Employee(2)) == 0);
            Assert.That(list.Head.Element.CompareTo(new Employee(1)) == 0);
            Assert.That(list.Tail.Element.CompareTo(new Employee(1)) == 0);
            Assert.True(CheckIntegrityBetweenAllNodes(list));
        }
        ...
        public void RemoveLast_on_list_3_updates_head_pointers_size_Test()
        {
            ...
            var returnedElement = list.RemoveLast();
            Assert.That(list.Size, Is.EqualTo(2));
            Assert.That(returnedElement.CompareTo(new Employee(3)) == 0);
            Assert.That(list.Head.Element.CompareTo(new Employee(1)) == 0);
            Assert.That(list.Tail.Element.CompareTo(new Employee(2)) == 0);
            Assert.True(CheckIntegrityBetweenAllNodes(list));
        }
        ...
        public void RemoveLast_on_larger_list_updates_head_pointers_size_Test()
        {
            ...
            var returnedElement = list.RemoveLast();
            Assert.That(list.Size, Is.EqualTo(listSize - 1));
            Assert.That(returnedElement.CompareTo(new Employee(listSize)) == 0);
            Assert.That(list.Head.Element.CompareTo(new Employee(1)) == 0);
            Assert.That(list.Tail.Element.CompareTo(new Employee(listSize - 1)) == 0);
            Assert.True(CheckIntegrityBetweenAllNodes(list));
        }
        ...
        public void RemoveLast_multiple_times_on_larger_list_updates_head_pointers_size_Test()
        {
            ...
            for (int i = 10, count = 1; i > 1; i--, count++)
            {
                var returnedElement = list.RemoveLast();
                Assert.That(returnedElement.CompareTo(new Employee(i)) == 0);
                Assert.That(list.Size, Is.EqualTo(listSize - count));
                Assert.That(list.Head.Element.CompareTo(new Employee(1)) == 0);
                Assert.That(list.Tail.Element.CompareTo(new Employee(listSize - count)) == 0);
                Assert.True(CheckIntegrityBetweenAllNodes(list));
            }
            var lastReturnedElement = list.RemoveLast();
            Assert.That(lastReturnedElement.CompareTo(new Employee(1)) == 0);
            Assert.That(list.IsEmpty());
            Assert.That(list.Head, Is.EqualTo(null));
            Assert.That(list.Tail, Is.EqualTo(null));
        }
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(5, out _);
            Assert.That(list.Get(1).CompareTo(list.GetFirst()).Equals(0));
        }
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(5, out _);
            Assert.That(list.Get(list.Size).CompareTo(list.GetLast()).Equals(0));
        }
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(5, out _);
            Assert.That(list.Get(3).CompareTo(list.Head.Next.Next.Element).Equals(0));
        }
        ...
        public void Get_By_Position_on_LARGE_existingList_returns_correct_elements_and_structure_is_not_changed_Test()
        {
            ...
            {
                Assert.That(list.Get(i).CompareTo(node.Element).Equals(0));
                node = node.Next;
            }
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = new DoublyLinkedLists.LinkedList<Employee>();
            Assert.That(() => list.AddAfter(new Employee(1), 1), Throws.Exception.TypeOf<ApplicationException>());
        }
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(1, out _);
            Assert.That(() => list.AddAfter(new Employee(2), -1), Throws.Exception.TypeOf<ApplicationException>());
        }
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(1, out _);
            Assert.That(() => list.AddAfter(new Employee(1), 0), Throws.Exception.TypeOf<ApplicationException>());
        }
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(1, out _);
            Assert.That(() => list.AddAfter(new Employee(1), list.Size + 1), Throws.Exception.TypeOf<ApplicationException>());
        }
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(1, out _);
            Assert.That(() => list.AddAfter(null, 1), Throws.Exception.TypeOf<ArgumentNullException>());
        }
        ...
        public void AddAfterByPosition_1_on_list_of_2_adding_inserts_between_head_tail_Test()
        {
            ...
            Assert.That(list.Head.Element.CompareTo(new Employee(1)) == 0);
            Assert.That(list.Head.Next.Element.CompareTo(new Employee(3)) == 0);
            Assert.That(list.Tail.Element.CompareTo(new Employee(2)) == 0);
        ...
        public void AddAfterByPosition_1_on_list_of_5_increases_size_updates_node_pointers_Test()
        {
            ...
            Assert.That(list.Head.Element.CompareTo(new Employee(1)) == 0);
            Assert.That(list.Head.Next.Element.CompareTo(new Employee(6)) == 0);
            Assert.That(list.Head.Next.Next.Element.CompareTo(new Employee(2)) == 0);
            Assert.That(list.Tail.Element.CompareTo(new Employee(5)) == 0);
            Assert.That(list.Size.Equals(6));
            Assert.True(CheckIntegrityBetweenAllNodes(list));
        }
        ...
        {
            Node<Employee>[] nodes;
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(8, out nodes);
            list.AddAfter(new Employee(9), 4); // insert 9 after 4: 1, 2, 3, 4, 9, 5, 6, 7, 8
            Assert.That(nodes[3].Element.CompareTo(new Employee(4)) == 0);
            Assert.That(nodes[3].Next.Element.CompareTo(new Employee(9)) == 0);
            Assert.That(nodes[4].Element.CompareTo(new Employee(5)) == 0);
            Assert.That(nodes[4].Previous.Element.CompareTo(new Employee(9)) == 0);
            Assert.That(list.Head.Element.CompareTo(new Employee(1)) == 0);
            Assert.That(list.Tail.Element.CompareTo(new Employee(8)) == 0);
            Assert.That(list.Size.Equals(9));
            Assert.True(CheckIntegrityBetweenAllNodes(list));
        }
        ...
        public void AddAfterByPosition_using_last_position_on_existingList_updates_tail_Test()
        {
            ...
            Assert.That(list.Size.Equals(6));
            Assert.That(list.Head.Element.CompareTo(new Employee(1)) == 0);
            Assert.That(list.Tail.Previous.Element.CompareTo(new Employee(5)) == 0);
            Assert.That(list.Tail.Element.CompareTo(new Employee(6)) == 0);
            Assert.True(CheckIntegrityBetweenAllNodes(list));
        }
        #endregion
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = new DoublyLinkedLists.LinkedList<Employee>();
            Assert.That(() => list.AddBefore(new Employee(1), 1), Throws.Exception.TypeOf<ApplicationException>());
        }
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(1, out _);
            Assert.That(() => list.AddBefore(new Employee(2), -1), Throws.Exception.TypeOf<ApplicationException>());
        }
        /// <summary>
        /// Ensure that calling AddBefore(element, position) with a value of zero results in an exception.
        /// </summary>
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(1, out _);
            Assert.That(() => list.AddBefore(new Employee(1), 0), Throws.Exception.TypeOf<ApplicationException>());
        }
        /// <summary>
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(1, out _);
            Assert.That(() => list.AddBefore(new Employee(1), list.Size + 1), Throws.Exception.TypeOf<ApplicationException>());
        }
        ...
        public void AddBeforeByPosition_last_position_on_list_of_5_increases_size_updates_node_pointers_Test()
        {
            ...
            Assert.That(list.Head.Element.CompareTo(new Employee(1)) == 0);
            Assert.That(list.Tail.Previous.Previous.Element.CompareTo(new Employee(4)) == 0);
            Assert.That(list.Tail.Previous.Element.CompareTo(new Employee(6)) == 0);
            Assert.That(list.Tail.Element.CompareTo(new Employee(5)) == 0);
            Assert.That(list.Size.Equals(6));
            Assert.True(CheckIntegrityBetweenAllNodes(list));
        }
        ...
        public void AddBeforeByPosition_middle_on_larger_list_increases_size_updates_node_pointers_Test()
        {
            ...
            Assert.That(nodes[2].Element.CompareTo(new Employee(3)) == 0);
            Assert.That(nodes[2].Next.Element.CompareTo(new Employee(9)) == 0);
            Assert.That(nodes[3].Element.CompareTo(new Employee(4)) == 0);
            Assert.That(nodes[3].Previous.Element.CompareTo(new Employee(9)) == 0);
            Assert.That(list.Head.Element.CompareTo(new Employee(1)) == 0);
            Assert.That(list.Tail.Element.CompareTo(new Employee(8)) == 0);
            Assert.That(list.Size.Equals(9));
            Assert.True(CheckIntegrityBetweenAllNodes(list));
        ...
        public void AddBeforeByPosition_using_first_position_on_existingList_updates_head_Test()
        {
            ...
            Assert.That(list.Size.Equals(6));
            Assert.That(list.Head.Element.CompareTo(new Employee(6)) == 0);
            Assert.That(list.Head.Next.Element.CompareTo(new Employee(1)) == 0);
            Assert.That(list.Tail.Element.CompareTo(new Employee(5)) == 0);
            Assert.True(CheckIntegrityBetweenAllNodes(list));
        }
        #endregion
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(1, out _);
            Assert.That(() => list.Remove(list.Size + 1), Throws.Exception.TypeOf<ApplicationException>());
        }
        ...
        public void RemoveByPosition_list_of_2_remove_head_updates_head_tail_Test()
        {
            ...
            Assert.That(list.Size, Is.EqualTo(1));
            Assert.That(list.Head.Element.CompareTo(new Employee(2)) == 0);
            Assert.That(list.Tail.Equals(list.Head));
        }
        ...
        public void RemoveByPosition_remove_middle_on_larger_list_Test()
        {
            ...
            Assert.That(list.Size, Is.EqualTo(listSize - 1));
            Assert.That(returnedElement.CompareTo(new Employee(listSize / 2)) == 0);
            Assert.That(list.Head.Element.CompareTo(new Employee(1)) == 0);
            Assert.That(list.Tail.Element.CompareTo(new Employee(listSize)) == 0);
            Assert.True(CheckIntegrityBetweenAllNodes(list));
        }
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = new DoublyLinkedLists.LinkedList<Employee>();
            Assert.That(() => list.Set(new Employee(1), 1), Throws.Exception.TypeOf<ApplicationException>());
        }
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(1, out _);
            Assert.That(() => list.Set(new Employee(2), -1), Throws.Exception.TypeOf<ApplicationException>());
        }
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(1, out _);
            Assert.That(() => list.Set(new Employee(2), 0), Throws.Exception.TypeOf<ApplicationException>());
        }
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(2, out _);
            Assert.That(() => list.Set(new Employee(2), list.Size + 1), Throws.Exception.TypeOf<ApplicationException>());
        }
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(1, out _);
            Assert.That(() => list.Set(null, 1), Throws.Exception.TypeOf<ArgumentNullException>());
        }
        ...
        public void SetByPosition_Returns_old_Element_Test()
        {
            ...
            Assert.That(returnValue.CompareTo(new Employee(1)) == 0); // old value returned
        }
        ...
        public void SetByPosition_1_on_list_of_1_updates_element_does_not_change_list_or_size_Test()
        {
            ...
            Assert.That(head.Element.CompareTo(new Employee(2)) == 0); // node in position 1 is now 2
            Assert.That(list.Head.Equals(head) && list.Tail.Equals(head)); // the head/tail is still the old head node in memory!
            Assert.That(list.Size.Equals(1)); // size hasn't changed
        ...
        public void SetByPosition_tail_on_large_list_updates_only_element_Test()
        {
            int listSize = 10;
            Node<Employee>[] nodes;
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(listSize, out nodes);
            var returnedElement = list.Set(new Employee(listSize + 1), list.Size);
            Assert.That(returnedElement.CompareTo(new Employee(listSize)) == 0);
            Assert.That(list.Tail.Element.CompareTo(new Employee(listSize + 1)) == 0);
            for (int i = 1, index = 0; i < listSize; i++, index++)
            {
                Assert.That(nodes[index].Element.CompareTo(new Employee(i)) == 0);
            }
            Assert.That(list.Size.Equals(listSize));
            Assert.True(CheckIntegrityBetweenAllNodes(list));
        }
        ...
        public void SetByPosition_head_on_large_list_updates_only_element_Test()
        {
            ...
            Assert.That(returnedElement.CompareTo(new Employee(1)) == 0);
            Assert.That(list.Head.Element.CompareTo(new Employee(listSize + 1)) == 0);
        ...
        public void SetByPosition_middle_on_large_list_updates_only_element_Test()
        {
            ...
            Assert.That(returnedElement.CompareTo(new Employee(list.Size / 2)) == 0);
            for (int i = 1, index = 0; i <= listSize; i++, index++)
            {
                if (i == list.Size / 2)
                    Assert.That(nodes[index].Element.CompareTo(new Employee(listSize + 1)) == 0);
                else
                    Assert.That(nodes[index].Element.CompareTo(new Employee(i)) == 0);
            }
            Assert.That(list.Size.Equals(listSize));
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = new DoublyLinkedLists.LinkedList<Employee>();
            Assert.That(() => list.Get(new Employee(1)), Throws.Exception.TypeOf<ApplicationException>());
        }
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(1, out _);
            Assert.That(() => list.Get(null), Throws.Exception.TypeOf<ArgumentNullException>());
        }
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(1, out _);
            Assert.That(() => list.Get(new Employee(2)), Throws.Exception.TypeOf<ApplicationException>());
        }
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(5, out _);
            Assert.That(() => list.Get(new Employee(6)), Throws.Exception.TypeOf<ApplicationException>());
        }
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(1, out _);
            Assert.That(list.Get(new Employee(1)).CompareTo(new Employee(1)) == 0);
        }
        ...
        public void GetByElement_returns_the_elements_on_large_list_Test()
        {
            ...
            for (int i = 1; i <= listSize; i++)
            {
                Assert.That(list.Get(new Employee(i)).CompareTo(new Employee(i)) == 0);
            }
        ...
        public void GetByElement_Multiple_matches_found_returns_first_match_test()
        {
            ...
            list.AddLast(new Employee(1));
            list.AddLast(new Employee(2));
            Assert.That(list.Get(employee).Equals(employee));
        }
        ...
        public void GetByElement_Multiple_matches_found_in_large_list_returns_first_match_test()
        {
            ...
            list.AddLast(new Employee(1));
            Assert.That(list.Get(employee2).Equals(employee2));
            // Ensure the node structure is still valid after running Get() (Head/Tail and pointers did not change)
            Assert.True(CheckIntegrityBetweenAllNodes(list));
        }
        #endregion
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = new DoublyLinkedLists.LinkedList<Employee>();
            Assert.That(() => list.AddAfter(new Employee(1), new Employee(2)), Throws.Exception.TypeOf<ApplicationException>());
        }
        ...
        public void AddAfterByElement_no_match_found_throws_exception_Test()
        {
            ...
            Assert.That(() => list.AddAfter(new Employee(3), new Employee(2)), Throws.Exception.TypeOf<ApplicationException>());
        }
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(1, out _);
            Assert.That(() => list.AddAfter(new Employee(2), null), Throws.Exception.TypeOf<ArgumentNullException>());
        }
        ...
        public void AddAfterByElement_multiple_match_found_adds_after_first_instance_Test()
        {
            ...
            Assert.That(list.Size.Equals(4));
            // list is now: 1, 1, 2, 3
            ...
            Assert.That(list.Head.Element.CompareTo(new Employee(1)) == 0);
            Assert.That(list.Head.Next.Element.Equals(newlyAddedEmployee));
            Assert.That(list.Tail.Element.CompareTo(new Employee(3)) == 0);
            Assert.True(CheckIntegrityBetweenAllNodes(list));
        }
        #endregion
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = new DoublyLinkedLists.LinkedList<Employee>();
            Assert.That(() => list.AddBefore(new Employee(1), new Employee(2)), Throws.Exception.TypeOf<ApplicationException>());
        }
        ...
        public void AddBeforeByElement_no_match_found_throws_exception_Test()
        {
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(1, out _);
            // There exists no Employee 2, so we cannot add 3 after 2. It should throw an exception
            Assert.That(() => list.AddBefore(new Employee(3), new Employee(2)), Throws.Exception.TypeOf<ApplicationException>());
        }
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(1, out _);
            Assert.That(() => list.AddBefore(new Employee(2), null), Throws.Exception.TypeOf<ArgumentNullException>());
        }
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(1, out _);
            Assert.That(() => list.AddBefore(null, new Employee(1)), Throws.Exception.TypeOf<ArgumentNullException>());
        }
        /// <summary>
        ...
        public void AddBeforeByElement_multiple_match_found_adds_before_first_instance_Test()
        {
            ...
            Assert.That(list.Size.Equals(5));
            Assert.That(list.Head.Element.Equals(newlyAddedEmployee));
            Assert.That(list.Head.Next.Element.CompareTo(new Employee(1)) == 0);
            Assert.That(list.Tail.Element.CompareTo(new Employee(3)) == 0);
            Assert.True(CheckIntegrityBetweenAllNodes(list));
        }
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = new DoublyLinkedLists.LinkedList<Employee>();
            Assert.That(() => list.Remove(new Employee(1)), Throws.Exception.TypeOf<ApplicationException>());
        }
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(1, out _);
            Assert.That(() => list.Remove(new Employee(2)), Throws.Exception.TypeOf<ApplicationException>());
        }
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(1, out _);
            Assert.That(() => list.Remove(null), Throws.Exception.TypeOf<ArgumentNullException>());
        }
        ...
        {
            Node<Employee>[] nodes;
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(3, out nodes);
            ...
            Assert.That(list.Size.Equals(3));
            Assert.That(list.Head.Element.CompareTo(new Employee(1)) == 0);
            Assert.That(list.Head.Next.Element.CompareTo(new Employee(2)) == 0);
            Assert.That(list.Tail.Element.CompareTo(new Employee(3)) == 0);
            Assert.That(list.Tail.Equals(duplicate));
            Assert.True(CheckIntegrityBetweenAllNodes(list));
        }
        #endregion
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = new DoublyLinkedLists.LinkedList<Employee>();
            Assert.That(() => list.Set(new Employee(2), new Employee(1)), Throws.Exception.TypeOf<ApplicationException>());
        }
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(1, out _);
            Assert.That(() => list.Set(new Employee(3), new Employee(2)), Throws.Exception.TypeOf<ApplicationException>());
        }
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(1, out _);
            Assert.That(() => list.Set(new Employee(1), null), Throws.Exception.TypeOf<ArgumentNullException>());
        }
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = CreateListWithoutMethods(1, out _);
            Assert.That(() => list.Set(null, new Employee(1)), Throws.Exception.TypeOf<ArgumentNullException>());
        }
        ...
        public void SetByElement_head_on_list_of_1_updates_element_does_not_change_list_or_size_Test()
        {
            ...
            Assert.That(head.Element.CompareTo(new Employee(2)) == 0); // node in position 1 is now 2
            Assert.That(list.Head.Equals(head) && list.Tail.Equals(head)); // the head/tail is still the old head node in memory!
            Assert.That(list.Size, Is.EqualTo(1)); // size hasn't changed
                                                   // check that pointers are still correct and head/tail has not changed:
            Assert.True(CheckIntegrityBetweenAllNodes(list));
        }
        ...
        public void SetByElement_multiple_matches_sets_first_match_test()
        {
            ...
            Assert.That(list.Size.Equals(4));
            Assert.That(list.Head.Element.CompareTo(new Employee(4)) == 0);
            Assert.That(list.Head.Next.Element.CompareTo(new Employee(1)) == 0);
            Assert.That(list.Tail.Element.CompareTo(new Employee(3)) == 0);
            Assert.That(list.Tail.Equals(duplicate));
            Assert.True(CheckIntegrityBetweenAllNodes(list));
        ...
        {
            DoublyLinkedLists.LinkedList<Employee> list = new DoublyLinkedLists.LinkedList<Employee>();
            Assert.That(() => list.Insert(null), Throws.Exception.TypeOf<ArgumentNullException>());
        }
        ...
        public void Insert_at_Head_when_element_smallest_Test()
        {
            ...
            Assert.That(list.Size.Equals(3));
            Assert.That(list.Head.Element.CompareTo(new Employee(0)) == 0);
            Assert.That(list.Head.Next.Element.CompareTo(new Employee(1)) == 0);
            Assert.That(list.Tail.Element.CompareTo(new Employee(2)) == 0);
            Assert.True(CheckIntegrityBetweenAllNodes(list));
        }
        ...
        public void Insert_duplicate_values_in_natural_order_test()
        {
            ...
            Assert.That(list.Head.Element.CompareTo(new Employee(1)) == 0);
            Assert.That(list.Head.Next.Element.CompareTo(new Employee(2)) == 0);
            Assert.That(list.Tail.Previous.Element.Equals(newEmployee));
            Assert.That(list.Tail.Element.CompareTo(new Employee(3)) == 0);
            Assert.True(CheckIntegrityBetweenAllNodes(list));
        }
        ...
        public void Insert_new_value_in_non_ordered_list_assigns_in_natural_order_test()
        {
            ...
            Assert.That(list.Head.Element.CompareTo(new Employee(1)) == 0);
            Assert.That(list.Head.Next.Element.CompareTo(new Employee(2)) == 0);
            Assert.That(list.Tail.Previous.Element.CompareTo(new Employee(4)) == 0);
            Assert.That(list.Tail.Element.CompareTo(new Employee(3)) == 0);
            Assert.True(CheckIntegrityBetweenAllNodes(list));
        }
        #endregion
        ...
        public void SortAscending_on_list_of_1_does_not_change_anything_test()
        {
            ...
            Assert.That(list.Size.Equals(1));
            Assert.That(list.Head.Element.CompareTo(new Employee(1)) == 0);
            Assert.That(list.Head.Equals(list.Tail));
            Assert.That(CheckIntegrityBetweenAllNodes(list));
        }
        ...
        public void SortAscending_on_large_Unsorted_list_sorts_ascending_test()
        {
            ...
            {
                Assert.That(node.Element.CompareTo(new Employee(randomNumbers[i])) == 0);
            }
            Assert.That(CheckIntegrityBetweenAllNodes(list));
        }
        ...
        /// <returns></returns>
        private bool CheckIntegrityBetweenAllNodes(DoublyLinkedLists.LinkedList<Employee> list)
        {
            bool isValid = true;
        ...
        private Node<Employee>[] ConvertToNodeArray(DoublyLinkedLists.LinkedList<Employee> list)
        {
        ...
        private DoublyLinkedLists.LinkedList<Employee> CreateListWithoutMethods(int size, out Node<Employee>[] nodeArray)
        {
